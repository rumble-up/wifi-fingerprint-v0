...
# -*- coding: utf-8 -*-
"""
Purpose: Drop wide range WAPs to see if it reduces big errors
Issues: Models are not auto-tuning now, they don't adapt to new data readily.
...
df_all = pd.read_csv('data/processed/df_remove_wide_waps.csv')
...
model_name = 'floor_rfc80_drop_range'
...
model_name = 'lat_xgb_tough_drop_range'
...
model_name = 'lon_xbg_tough_drop_wide'
...
df_pred.to_csv('predictions/mvp2_drop_wide_wap_dumb.csv')
